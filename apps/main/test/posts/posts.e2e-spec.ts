...
describe('Testing new flow upload files and create post -  e2e', () => {
  ...
  it.skip('17 - / (POST) - should return 201 if all data is correct for create post', async () => {
  ...
  let userId: number;
  let userId2: number;
  it.skip('41 - / (GET) - should return 200 and info about logged user', async () => {
    const myInfo = await authHelper.me(accessToken);
    const myInfo2 = await authHelper.me(accessToken2);
    userId = myInfo.userId;
    userId2 = myInfo2.userId;
  });
  it.skip('42 - / (GET) - should return 200 posts with pagination for FIRST user', async () => {
  ...
  it.skip('43 - / (GET) - should return 200 posts with pagination for SECOND user', async () => {
  ...
  //Get post
  it.skip('50 - / (GET) - should return 200 with empty array images', async () => {
  ...
  it.skip('20 - / (POST) - should create user and returned accessToken', async () => {
  ...
  it.skip('21 - / (POST) - should return 201 if all data is correct for create post', async () => {
    let nameFile = '/images/image2.jpeg';
    let nameFile2 = '/images/image1.png';
  ...
  //delete image
  it.skip('22 - / (DELETE) - should return 204 and delete image', async () => {
    const query = { postId: post4.id, uploadId: uploadId1 };
    await postsHelper.deleteImage(query, { token: accessToken3, expectedCode: 204 });
  });
  //get post
  it.skip('23 - / (GET) - should return 200 and post without deleted image', async () => {
  ...
  //delete image
  it.skip('24 - / (DELETE) - should return 204 and delete image', async () => {
    const query = { postId: post4.id, uploadId: uploadId2 };
    await postsHelper.deleteImage(query, { token: accessToken3, expectedCode: 204 });
  });
  //get post
  it.skip('25 - / (GET) - should return 200 and post without deleted image', async () => {
    const foundPost: PostViewModel = await postsHelper.getPost(post4.id, { token: accessToken3, expectedCode: 200 });
    expect(foundPost.images).toHaveLength(1);
  });
  //delete image
  it.skip('26 - / (DELETE) - should return 403 so user can`t delete last image', async () => {
  ...
  //new post
  it.skip('27 - / (POST) - should return 201 if all data is correct for create post', async () => {
    let nameFile = '/images/image2.jpeg';
    let nameFile2 = '/images/image1.png';
    let nameFile3 = '/images/667x1000_345kb.jpeg';
